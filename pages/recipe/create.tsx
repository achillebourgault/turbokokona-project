...
const Create = () => {
    ...
    return (
        <>
            ...
            {uid ? <div className={styles.customContainer}>
                ...
                <div className={styles.connectSection}>
                    <div className={styles.connectText}>You should be logged-in in order to create your own recipe</div>
                    <div className={styles.connectBox}>
                        <a className={styles.connectBtn} href={"/signUp"}>Create / Connect your account</a>
                    </div>
                </div>
            }
            <Footer/>
